            ...
            <div class="row gy-4">
                <div class="col-lg-3  col-sm-6">
                    <div class="service-wrapper free-shipping">
                        ...
                        <div class="service-content">
                            <h5 class="service-info service-title">Free
                                Shipping</h5>
                            <p class="service-info service-details">When
                                ordering over $100</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="service-wrapper free-shipping">
                        ...
                        <div class="service-content">
                            <h5 class="service-info service-title">Free
                                Return</h5>
                            <p class="service-info service-details">Get
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="service-wrapper free-shipping">
                        ...
                        <div class="service-content">
                            <h5 class="service-info service-title">Secure
                                Payment</h5>
                            <p class="service-info service-details">100%
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="service-wrapper free-shipping">
                        ...
                        <div class="service-content">
                            <h5 class="service-info service-title">Best
                                Quality</h5>
                            <p class="service-info service-details">Original
                                Product Guarenteed</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="footer-order">
                        ...
                        <div class="footer-link order-link">
                            <ul>
                                <li><a href="order.html">Track
                                        Order</a></li>
                                <li><a href="cart.html">Delivery &
                                        Returns</a></li>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="about-us">
                        ...
                        <div class="footer-link about-link">
                            <ul>
                                <li><a href="about.html">Rave’s
                                        Story</a></li>
                                <li><a href="about.html">Work With
                                        Us</a></li>
                                <li><a href="about.html">Coporate
                                        News</a></li>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="links">
                        ...
                        <div class="footer-link useful-link">
                            <ul>
                                <li><a href="about.html">Secure
                                        Payment</a></li>
                                <li><a href="privacy.html">Privacy
                                        Policy</a></li>
                                <li><a href="terms.html">Terms of
                                        Use</a></li>
                                <li><a href="product-sidebar.html">Archived
                                        Products</a></li>
                            </ul>
                        </div>
                    </div>

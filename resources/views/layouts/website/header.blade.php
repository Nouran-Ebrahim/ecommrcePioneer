        ...
        <div class="container">
            <div class="header-top">
                <div class="header-profile">
                    ...
                    <a href="{{ route('website.faq') }}"><span>{{ __('website.support') }}</span></a>
                </div>
                            ...
                            <ul class="header-sub-menu">
                                @if ($pages->count() > 0)
                                    @foreach ($pages as $item)
                                        <li><a
                                                href="{{ route('website.daynamic.page', $item->slug) }}">{{ $item->title }}</a>
                                        </li>
                                    @endforeach
                                @endif

                                <li><a href="{{ route('website.faq') }}">{{ __('website.faq') }}</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="about.html">

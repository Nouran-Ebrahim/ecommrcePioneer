                                ...
                                <div class="wrapper">
                                    <div class="wrapper-item">
                                        ...
                                        <div class="wrapper-content">
                                            <h5 class="wrapper-title">Classic
                                                Design Skart</h5>
                                            <div class="price">
            ...
            <div class="header-nav">
                                ...
                                <div class="menu-wrapper">
                                    <div class="menu-list">
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="product-sidebar.html">
                                                    T-Shirt</a></li>
                                        </ul>
                                    </div>
                                    <div class="menu-list">
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="product-sidebar.html">Mobile
                                                    Bags</a></li>
                                            <li><a href="product-sidebar.html">School
                                                    Bags</a></li>
                                        </ul>
                                    </div>
                                    <div class="menu-list">
                            ...
                            <li>
                                ...
                                <ul class="header-sub-menu">
                                    @foreach ($pages as $page)
                                        <li><a
                                                href="{{ route('website.daynamic.page', $page->slug) }}">{{ $page->title }}</a>
                                        </li>
                                    @endforeach
                                    <li>
                ...
                <div class="header-vendor-btn">
                    <a href="become-vendor.html" class="shop-btn">
                        <span class="list-text shop-text">Became
                            Vendor</span>
                        <span class="icon">

                                ...
                                <form action="{{ route('dashboard.settings.update', $setting->id) }}" method="POST"
                                    ...
                                    <div class="form-body">
                                        ...
                                        <h4 class="form-section"><i
                                                class="la la-eye"></i>{{ __('dashboard.general_settings') }}</h4>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="col-md-3 label-control"
                                                        for="userinput1">{{ __('dashboard.name_ar') }}</label>
                                                    <div class="col-md-9">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="col-md-3 label-control"
                                                        for="userinput1">{{ __('dashboard.name_en') }}</label>
                                                    <div class="col-md-9">
                                                        <input readonly type="text" id="userinput1"
                                                            class="form-control border-primary "
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="col-md-3 label-control"
                                                        for="userinput1">{{ __('dashboard.description_ar') }}</label>
                                                    <div class="col-md-9">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="col-md-3 label-control"
                                                        for="userinput1">{{ __('dashboard.description_en') }}</label>
                                                    <div class="col-md-9">
                                        ...
                                        {{-- socail --}}
                                        <h4 class="form-section"><i
                                                class="la la-envelope"></i>{{ __('dashboard.socialLinks') }}</h4>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="col-md-3 label-control"
                                                        for="userinput5">{{ __('dashboard.facebook_link') }}</label>
                                                    <div class="col-md-9">
                                                        <input readonly name="facebook_url"
                                                            class="form-control border-primary " type="url"
                                                            placeholder="{{ __('dashboard.facebook_link') }}" id="userinput5"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="col-md-3 label-control"
                                                        for="userinput5">{{ __('dashboard.fav_icon') }}</label>
                                                    <div class="col-md-9">
                                                        <input  name="favicon" id="favicon-image"
                                                            class="form-control border-primary " type="file"
                                                            placeholder="{{ __('dashboard.fav_icon') }}" >
                                                        @error('favicon')
                                                            <strong class="text-danger"> {{ $message }}</strong>
                                                        @enderror
                                                    </div>
                                    ...
                                    <div class="form-actions right">
                                        <button hidden id="cancel_btn" type="reset" class="btn btn-warning mr-1">

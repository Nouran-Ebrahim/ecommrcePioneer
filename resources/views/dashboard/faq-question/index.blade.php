        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                    <h3 class="content-header-title mb-0 d-inline-block">{{ __('dashboard.faqsQuestions') }}</h3>
                    <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('dashboard.faqsQuestions.index') }}">
                                        {{ __('dashboard.faqsQuestions') }}</a>
                                </li>
...
@endsection
@push('script')
    {{-- display errors during create faqsQuestion --}}
    @if ($errors->any())
        <script>
    ...
    <script>
        ...
        $('#yajra_table').DataTable({
            ...
            ajax: "{{ route('dashboard.faqsQuestions.all') }}",
            columns: [{
                    data: 'DT_RowIndex',
                    searchable: false,
                    orderable: false,

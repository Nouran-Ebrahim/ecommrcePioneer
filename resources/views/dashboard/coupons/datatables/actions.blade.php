<div class="form-group">
    <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
        ...
        <button class="edit_coupon btn btn-outline-success" coupon-id="{{ $coupon->id }}"
            coupon-code="{{ $coupon->code }}" coupon-limit="{{ $coupon->limit }}"
            coupon-discount="{{ $coupon->discount_percentage }}" coupon-start-date="{{ $coupon->start_date }}"
            coupon-end-date="{{ $coupon->end_date }}" coupon-status="{{ $coupon->status }}">
        ...
        <button id="btnGroupDrop2" coupon-id="{{ $coupon->id }}" type="button"

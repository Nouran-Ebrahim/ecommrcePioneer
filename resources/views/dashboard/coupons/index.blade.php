            ...
            responsive: {
                details: {
                    display: DataTable.Responsive.display.modal({
                        header: function(row) {
                            var data = row.data();
                            return '@lang('dashboard.Details for') ' + data['code'];
                        }
                    }),
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.status == 'success') {
                        ...
                        $('#yajra_table').DataTable().page(currentPage).draw(
                            false); // add coupon without refreshing the page
                ...
                error: function(data) {
                    if (data.responseJSON.errors) {
                        $.each(data.responseJSON.errors, function(key, value) {
                            // key is the name of the input field like code , limit, etc
                            //anthor solution

            ...
            <div class="modal-body">
                ...
                <form faq-id="{{ $item->id }}" action="" class="form update_faq_form" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="answer[ar]">{{ $item->getTranslation('answer', 'ar') }}</textarea>
                    </div>

                    <div class="form-group">
                        <label for="name">{{ __('dashboard.answer_en') }}</label>
                        <textarea class="form-control" name="answer[en]">{{ $item->getTranslation('answer', 'en') }}</textarea>
                    </div>

    ...
    <section class="blog about-blog">
        <div class="container">
            ...
            <div class="blog-heading about-heading">
                <h1 class="heading">@lang('dashboard.faqs')</h1>
            </div>
        </div>
    </section>
            ...
            <div class="row gy-5">
                <div class="col-lg-6">
                    <div class="faq-accordion accordion accordion-flush" id="accordionFlushExample" data-aos="fade-right">
                        <h5>@lang('dashboard.faqs')</h5>
                        @forelse ($Faqs as $faq)
                            <div class="faq-item accordion-item">
                                <h2 class="accordion-header">
                                    <button class="faq-button accordion-button collapsed" type="button"
                                        data-bs-toggle="collapse" data-bs-target="#flush-collapse_{{ $faq->id }}"
                                ...
                                <div id="flush-collapse_{{ $faq->id }}" class="accordion-collapse collapse"
                        ...
                        @empty
                            <div class="alert-info">@lang('dashboard.no data')</div>
                        @endforelse
                    </div>
                </div>
                <div class="col-lg-6">
...
@push('script')
    ...
    <script>
        ...
        document.addEventListener('livewire:init', () => {
            Livewire.on('faq-question-faild', (event) => {
                Swal.fire({
                    position: "top-center",
                    icon: "error",

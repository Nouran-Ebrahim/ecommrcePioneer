        ...
        <div class="user-profile-section">
            <div class="dashboard-heading ">
                ...
                <div class="dashboard-switch">
                    ...
                    <span onclick="switchDashboard()"
                        class="switch-icon"></span>
                </div>
            </div>
            <div class="user-dashboard">
                <div class="nav nav-item nav-pills  me-3"
                    ...
                    <button class="nav-link" id="v-pills-payment-tab"
                        ...
                        role="tab" aria-controls="v-pills-payment"
                        aria-selected="false">
                        <span>
                    ...
                    <button class="nav-link" id="v-pills-order-tab"
                        data-bs-toggle="pill"
                        data-bs-target="#v-pills-order" type="button"
                        role="tab" aria-controls="v-pills-order"
                        aria-selected="false">
                        <span>
                    ...
                    <button class="nav-link" id="v-pills-wishlist-tab"
                        data-bs-toggle="pill"
                        data-bs-target="#v-pills-wishlist" type="button"
                        role="tab" aria-controls="v-pills-wishlist"
                        aria-selected="false">
                        <span>
                    ...
                    <button class="nav-link" id="v-pills-address-tab"
                        data-bs-toggle="pill"
                        data-bs-target="#v-pills-address" type="button"
                    ...
                    <button class="nav-link" id="v-pills-review-tab"
                        data-bs-toggle="pill"
                        data-bs-target="#v-pills-review" type="button"
                        role="tab" aria-controls="v-pills-review"
                        aria-selected="false">
                        <span>
                    ...
                    <button class="nav-link" id="v-pills-password-tab"
                        ...
                        role="tab" aria-controls="v-pills-password"
                        aria-selected="false">
                        <span>
                    ...
                    <button class="nav-link" id="v-pills-ticket-tab"
                        data-bs-toggle="pill"
                        data-bs-target="#v-pills-ticket" type="button"
                        role="tab" aria-controls="v-pills-ticket"
                        aria-selected="false">
                        <span>
                    ...
                    <div class="nav-link">
                        <form style="display: none" id="logoutForm" action="{{ route('website.logout.post') }}" method="post">
                            @csrf
                        </form>
                ...
                <div class="tab-content nav-content"
                    id="v-pills-tabContent" style="flex: 1 0%;">
                    <div class="tab-pane fade show active"
                        ...
                        <div class="user-profile">
                            <div class="user-title">
                                ...
                                <h5 class="heading">Welcome to your
                                    Profile </h5>
                            </div>
                                    ...
                                    <div class="col-lg-4 col-sm-6">
                                        <div class="product-wrapper">
                                            ...
                                            <div
                                                class="wrapper-content">
                                                <p
                                                    class="paragraph">Delivery
                                                    Completed</p>
                                                <h3
                                                    class="heading">99783</h3>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-sm-6">
                                                ...
                                                <div class="info-list">
                                                    ...
                                                    <div
                                                        ...
                                                        <p><a
                                                                ...
                                                                class="__cf_email__"
                                                                data-cfemail="cbafaea6a4aea6aaa2a78baca6aaa2a7e5a8a4a6">[email&#160;protected]</a></p>
                                                        <p>023 434
                                                            54354</p>
                                                        <p>Haydarabad,
                                                            Rord 34</p>
                                                ...
                                                <div class="info-list">
                                                    ...
                                                    <div
                                                        ...
                                                        <p><a
                                                                href="https://quomodothemes.website/cdn-cgi/l/email-protection"
                                                                class="__cf_email__"
                                                                data-cfemail="2a4e4f47454f474b43466a4d474b434604494547">[email&#160;protected]</a></p>
                                                        <p>023 434
                                                            54354</p>
                                                        <p>Haydarabad,
                                                            Rord 34</p>
                                ...
                                <div class="col-lg-7">
                                    <div class=" account-section">
                                        <div class="review-form">
                                            ...
                                            <div
                                                class="review-form-name address-form">
                                                <label for="addres"
                                            ...
                                            <div
                                                class=" account-inner-form city-inner-form">
                                                <div
                                                    class="review-form-name">
                                                    <label
                                                        for="teritory"
                                                        class="form-label">Town
                                                        / City*</label>
                                                    <select
                                                        id="teritory"
                                                        class="form-select">
                                            ...
                                            <div class="submit-btn">
                                                ...
                                                <a href="#"
                                                    class="shop-btn update-btn">Update
                                                    Profile</a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-5">
                                    <div class="img-upload-section">
                                        <div class="logo-wrapper">
                                            <h5
                                                class="comment-title">Update
                                                Logo</h5>
                                            <p
                                                class="paragraph">Size300x300.
                                                Gifs work
                                                too.Max 5mb.</p>
                        ...
                        <div class="payment-section">
                            <div class="wrapper">
                                <div class="wrapper-item">
                                    ...
                                    <div class="wrapper-content">
                                        <h5 class="heading">Dutch Bangl
                                            Bank Lmtd</h5>
                                        <p class="paragraph">Bank
                                            **********5535</p>
                            ...
                            <div class="wrapper-btn">
                                <a href="#" class="shop-btn"
                                    onclick="modalAction('.cart')">Add
                                    Cart</a>

                                <div class="modal-wrapper cart">
                                    <div onclick="modalAction('.cart')"
                                        class="anywhere-away"></div>

                                    <div
                                        class="login-section account-section modal-main">
                                        <div class="review-form">
                                            <div class="review-content">
                                                <h5
                                                    class="comment-title">Add
                                                    New Card</h5>
                                                <div class="close-btn">
                                                    <img
                                ...
                                <a href="#" class="shop-btn bank-btn"
                                    onclick="modalAction('.bank')">Add
                                    Bank</a>

                                <div class="modal-wrapper bank">
                                    <div onclick="modalAction('.bank')"
                                        class="anywhere-away"></div>
                            ...
                            <table>
                                <tbody>
                                    <tr class="table-row table-top-row">
                                        <td
                                            class="table-wrapper wrapper-product">
                                            <h5
                                                class="table-heading">PRODUCT</h5>
                                        </td>
                                        <td class="table-wrapper">
                                            <div
                                                class="table-wrapper-center">
                                                <h5
                                                    class="table-heading">PRICE</h5>
                                            </div>
                                        </td>
                                        <td class="table-wrapper">
                                            <div
                                                class="table-wrapper-center">
                                                <h5
                                                    class="table-heading">QUANTITY</h5>
                                            </div>
                                        </td>
                                        <td
                                            class="table-wrapper wrapper-total">
                                            <div
                                                class="table-wrapper-center">
                                                <h5
                                                    class="table-heading">TOTAL</h5>
                                            </div>
                                        </td>
                                        <td class="table-wrapper">
                                            <div
                                        ...
                                        <td
                                            ...
                                            <div class="wrapper">
                                                <div
                                                    class="wrapper-img">
                                                    <img
                                                        src="assets/images/homepage-one/product-img/product-img-1.webp"
                                                        alt="img">
                                                </div>
                                                <div
                                                    class="wrapper-content">
                                                    <h5
                                                        class="heading">Classic
                                                        Design
                                                        Skart</h5>
                                                </div>
                                            </div>
                                        ...
                                        <td
                                            ...
                                            <div class="wrapper">
                                                <div
                                                    class="wrapper-img">
                                                    <img
                                                        src="assets/images/homepage-one/product-img/product-img-2.webp"
                                                        alt="img">
                                                </div>
                                                <div
                                                    class="wrapper-content">
                                        ...
                                        <td
                                            ...
                                            <div class="wrapper">
                                                <div
                                                    class="wrapper-img">
                                                    <img
                                                        src="assets/images/homepage-one/product-img/product-img-3.webp"
                                                        alt="img">
                                                </div>
                                                <div
                                                    class="wrapper-content">
                                        ...
                                        <td
                                            ...
                                            <div class="wrapper">
                                                <div
                                                    class="wrapper-img">
                                                    <img
                                                        src="assets/images/homepage-one/product-img/product-img-4.webp"
                                                        alt="img">
                                                </div>
                                                <div
                                                    class="wrapper-content">
                    ...
                    <div class="tab-pane fade" id="v-pills-wishlist"
                        ...
                        <div class="wishlist">
                            <div class="cart-content">
                                ...
                                <p>Order ID: <span
                                        class="inner-text">#4345</span></p>
                            </div>
                            <div class="cart-section wishlist-section">
                                <table>
                                    <tbody>
                                        <tr
                                            class="table-row table-top-row">
                                            <td
                                                class="table-wrapper wrapper-product">
                                                <h5
                                                    class="table-heading">PRODUCT</h5>
                            ...
                            <div class="wishlist-btn">
                                <a href="#" class="clean-btn">Clean
                                    Wishlist</a>
                                <a href="#" class="shop-btn">View
                                    Cards</a>
                            </div>
                        </div>
                    </div>
                    <div class="tab-pane fade" id="v-pills-address"
                        ...
                        tabindex="0">
                        <div
                            class="profile-section address-section addresses ">
                            <div class="row gy-md-0 g-5">
                                <div class="col-md-6">
                                    <div class="seller-info">
                                        <h5
                                            class="heading">Address-01</h5>
                                        <div class="info-list">
                                            ...
                                            <div class="info-details">
                                                ...
                                                <p><a
                                                        href="https://quomodothemes.website/cdn-cgi/l/email-protection"
                                                        class="__cf_email__"
                                                        data-cfemail="791d1c14161c14181015391e14181015571a1614">[email&#160;protected]</a></p>
                                                <p>023 434 54354</p>
                                                <p>Haydarabad, Rord
                                                    34</p>
                                                <p>3454</p>
                                        ...
                                        <div class="info-list">
                                            ...
                                            <div class="info-details">
                                                ...
                                                <p><a
                                                        href="https://quomodothemes.website/cdn-cgi/l/email-protection"
                                                        class="__cf_email__"
                                                        data-cfemail="ec8889818389818d8580ac8b818d8580c28f8381">[email&#160;protected]</a></p>
                                                <p>023 434 54354</p>
                                                <p>Haydarabad, Rord
                                                    34</p>
                                                <p>3454</p>
                                ...
                                <div class="col-lg-6">
                                    <a href="#" class="shop-btn"
                                        onclick="modalAction('.submit')">Add
                                        New
                                        Address</a>
                            ...
                            <div class="row g-5">
                                <div class="col-md-6">
                                    <div class="product-wrapper">
                                        <div class="product-img">
                                            <img
                                                src="assets/images/homepage-one/product-img/product-img-5.webp"
                                                alt="product-img">
                                        </div>
                                        <div class="product-info">
                                            ...
                                            <div
                                                ...
                                                <a
                                                    ...
                                                    class="product-details">Rainbow
                                                    Sequin Dress
                                                </a>
                                                <p>Didn't I tell you not
                                                    put your phone on
                                                    charge because
                                                    weekend?
                                                </p>
                                ...
                                <div class="col-md-6">
                                    <div class="product-wrapper">
                                        <div class="product-img">
                                            <img
                                                src="assets/images/homepage-one/product-img/product-img-6.webp"
                                                alt="product-img">
                                        </div>
                                        <div class="product-info">
                                            <div class="review-date">
                                ...
                                <div class="col-md-6">
                                    <div class="product-wrapper">
                                        <div class="product-img">
                                            <img
                                                src="assets/images/homepage-one/product-img/product-img-7.webp"
                                                alt="product-img">
                                        </div>
                                        <div class="product-info">
                                            <div class="review-date">
                                ...
                                <div class="col-md-6">
                                    <div class="product-wrapper">
                                        <div class="product-img">
                                            <img
                                                src="assets/images/homepage-one/product-img/product-img-8.webp"
                                                alt="product-img">
                                        </div>
                                        <div class="product-info">
                                            <div class="review-date">
                            ...
                            <div class="col-lg-6">
                                <div class="form-section">
                                    <form action="#">
                                        ...
                                        <div
                                            class="re-password form-item">
                                            <label for="repass"
                                                class="form-label">Re-enter
                                                Password*</label>
                                            <input type="password"
                                                class="form-control"
                                                id="repass"
                    ...
                    <div class="tab-pane fade" id="v-pills-ticket"
                        role="tabpanel"
                        aria-labelledby="v-pills-ticket-tab"
                        tabindex="0">
                        <div class="support-ticket">
                            <a href="#" class="shop-btn"
                                onclick="modalAction('.ticket')">Add New
                                Support</a>
                                ...
                                <table>
                                    <tbody>
                                        <tr
                                            ...
                                            <td class="table-wrapper">
                                                <h5
                                                    class="table-heading">NO</h5>
                                            </td>
                                            <td class="table-wrapper">
                                                <div
                                                    class="table-wrapper-center">
                                                    <h5
                                                        class="table-heading">TIME</h5>
                                                </div>
                                            </td>
                                            <td class="table-wrapper">
                                                <div
                                        ...
                                        <tr
                                            ...
                                            <td class="table-wrapper">
                                                <p
                                                    class="ticker-number">#354</p>
                                            </td>
                                            <td class="table-wrapper">
                                                <div
                                                    class="table-wrapper-center">
                                                    <p
                                                        class="ticket-date">11th
                                                        Oct, 2023</p>
                                                </div>
                                            </td>
                                            <td class="table-wrapper">
                                                <div
                                                    class="table-wrapper-center">
                                                    <p
                                                        class="ticket-info">Printing
                                                        and typesetting
                                                        industry
                                                        standard <span
                                                            class="inner-text">dummy
                                                            text ever
                                                            since</span></p>
                                                </div>
                                            </td>
                                            <td class="table-wrapper">
                                                <div
                                                    class="table-wrapper-center table-wrapper-img">
                                                    <div
                                                        class="comment-img">
                                                        <span>
                                                            <svg

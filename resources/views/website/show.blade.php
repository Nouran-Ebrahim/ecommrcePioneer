    ...
    <section class="product product-info">
        <div class="container">
            <div class="blog-bradcrum">
                ...
                <span class="devider">/</span>
                <span><a href="javascript:;">{{ $product->name }}</a></span>
            </div>
                ...
                <div class="row ">
                    ...
                    <div class="col-md-6">
                        <div class="product-info-content" data-aos="fade-left">
                            <span class="wrapper-subtitle">BOY'S
                                FASHION</span>
                            ...
                            <p class="content-paragraph">It is a long
                                established fact that a reader will be
                                distracted
                                by <span class="inner-text">the readable
                                    there content of a page.</span></p>
                            <hr>
                            <div class="product-availability">
                                <span>Availabillity : </span>
                                <span class="inner-text">132 Products
                                    Available</span>
                            </div>
                            <div class="product-size">
                                <p class="size-title">Size</p>
                                <div class="size-section">
                                    <span class="size-text">Select your
                                        size</span>
                                ...
                                <ul class="size-option">
                                    <li class="option">
                                        ...
                                        <span class="option-measure">3”W x
                                            3”D x 5”H</span>
                                    </li>
                                    <li class="option">
                                    ...
                                    <li class="option">
                                        ...
                                        <span class="option-measure">6”W x
                                            3”D x 7”H</span>
                                    </li>
                                    <li class="option">
                                        <span class="option-text">Extra
                                            Large</span>
                                        <span class="option-measure">8”W x
                                            4”D x 8”H</span>
                                    </li>
                                    <li class="option">
                                        <span class="option-text">2XL</span>
                                        <span class="option-measure">10”W x
                                            5”D x 9”H</span>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="product-details">
                                ...
                                <p class="tags">Tags : <span class="inner-text">Beer,
                                        Foamer</span></p>
                                    ...
                                    <div class="login-section account-section modal-main">
                                        <div class="review-form">
                                            ...
                                            <div class="review-form-name address-form">
                                                <label for="reporttitle" class="form-label">Enter
                                                    Report Ttile*</label>
                                                <input type="text" id="reporttitle" class="form-control"
                                                    placeholder="Reports Headline here">
                                            </div>
                                            <div class="review-form-name address-form">
                                                <label for="reportnote" class="form-label">Enter
                                                    Report Note*</label>
                    ...
                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab"
                        ...
                        {{-- <div class="product-feature">
                            ...
                            <ul>
                                ...
                                <li>
                                    <p>latest Intel Core i5-1135G7 processor
                                        (4 cores / 8 threads)</p>
                                </li>
                                <li>
                                    <p>8GB DDR4 RAM and fast 512GB PCIe
                                        SSD</p>
                                </li>
                                <li>
                                    <p>NVIDIA GeForce MX350 2GB GDDR5
                                        graphics card backlit keyboard,
                                        touchpad with
                                        gesture support</p>
                                </li>
                            </ul>
                    ...
                    <div class="tab-pane fade" id="nav-review" role="tabpanel" aria-labelledby="nav-review-tab"
                        ...
                        <div class="product-review-section" data-aos="fade-up">
                            ...
                            <div class="review-wrapper">
                                ...
                                @empty
                                    <div role="alert" class="alert-info">no reviews</div>
                                @endforelse
    ...
    <section class="product weekly-sale product-weekly footer-padding">
        <div class="container">
            <div class="section-title">
                ...
                <a href="{{ route('website.products.related', $product) }}" class="view">View All</a>
            </div>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="product-wrapper" data-aos="fade-up">
                                <div class="product-img">
                                    <img src="{{ asset('uploads/products/' . $related->images->first()->file_name) }}"
                                        alt="product-img">
                                ...
                                <div class="product-info">
                                    ...
                                    <div class="product-description">
                                        <a href="product-info.html" class="product-details">{{ $related->name }}
                                        </a>
                                        <div class="price">
                                            @if ($related->has_variants == 1)
                                                <span class="new-price">{{ __('dashboard.has_variants') }}</span>
                                            @else
                                                @if ($related->has_discount == 0)
                                                    <span class="new-price">{{ $related->price }} EGP</span>
                                                @else
                                                    <span class="price-cut">{{ $related->price }} EGP</span>
                                                    <span class="new-price">{{ $related->getPriceAfterDiscount() }}
                                                        EGP</span>
                                                @endif
                                            @endif
                                ...
                                <div class="product-cart-btn">
                                    <a href="{{ route('website.products.show', $related->slug) }}"
                                        class="product-btn">@lang('dashboard.show')</a>
                                </div>
                            </div>
                        </div>
                    @empty
                        <div role="alert" class="alert info"> No products</div>
                    @endforelse

            ...
            <div class="category-section">
                @foreach ($someCategories as $category)
                    <div class="product-wrapper" data-aos="fade-right" data-aos-duration="100">
                        ...
                        <div class="wrapper-info">
                            <a href="{{ route('website.categories.products', $category->slug) }}"
        ...
        <section class="product arrival">
            <div class="container">
                ...
                <div class="arrival-section">
                    <div class="row g-5">
                        @foreach ($newAriavals as $ariaval)
                            <div class="col-lg-3 col-sm-6">
                                <div class="product-wrapper" data-aos="fade-up">
                                    <div class="product-img">
                                        <img src="{{ asset('uploads/products/' . $ariaval->images->first()->file_name) }}"
                                            alt="product-img">
                                        <div class="product-cart-items">
                                            <a href="{{ route('website.products.show', $ariaval->slug) }}"
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="product-description">
                                            ...
                                            <div class="price">
                                                @if ($ariaval->has_variants == 1)
                                                    <span class="new-price">{{ __('dashboard.has_variants') }}</span>
                                                @else
                                                    @if ($ariaval->has_discount == 0)
                                                        <span class="new-price">{{ $ariaval->price }} EGP</span>
                                                    @else
                                                        <span class="price-cut">{{ $ariaval->price }} EGP</span>
                                                        <span class="new-price">{{ $ariaval->getPriceAfterDiscount() }}
                                                            EGP</span>
                                                    @endif
                                                @endif
                                    ...
                                    <div class="product-cart-btn">
                                        <a href="{{ route('website.categories.products', $ariaval->category->slug) }}"
                                            class="product-btn">
                                            {{ $ariaval->category->name }}
        ...
        <section class="product flash-sale">
            <div class="container">
                ...
                <div class="flash-sale-section">
                    <div class="row g-5">
                        @foreach ($flashProudctsTimer as $timer)
                            <div class="col-lg-3 col-md-6">
                                <div class="product-wrapper" data-aos="fade-right" data-aos-duration="100">
                                    <div class="product-img">
                                        <img src="{{ asset('uploads/products/' . $timer->images->first()->file_name) }}"
                                            alt="product-img">
                                        <div class="product-cart-items">
                                            <a href="{{ route('website.products.show', $timer->slug) }}"
                                                class="cart cart-item">
                                                <span>
                                                    <svg width="40" height="40" viewBox="0 0 40 40"
                                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="product-description">
                                            <a href="{{ route('website.products.show', $timer->slug) }}"
                                                class="product-details">{{ $timer->name }}
                                            </a>
                                            <div class="price">
                                                @if ($timer->has_variants == 1)
                                                    <span class="new-price">{{ __('dashboard.has_variants') }}</span>
                                                @else
                                                    @if ($timer->has_discount == 0)
                                                        <span class="new-price">{{ $timer->price }} EGP</span>
                                                    @else
                                                        <span class="price-cut">{{ $timer->price }} EGP</span>
                                                        <span class="new-price">{{ $timer->getPriceAfterDiscount() }}
                                                            EGP</span>
                                                    @endif
                                                @endif
                                    ...
                                    <div class="product-cart-btn">
                                        <a href="{{ route('website.categories.products', $timer->category->slug) }}"
                                            class="product-btn">{{ $timer->category->name }}</a>
                                    </div>
                                </div>
                            </div>
                        @endforeach
        ...
        <section class="product best-product">
            <div class="container">
                ...
                <div class="best-product-section">
                    <div class="row g-4">
                        @foreach ($flashProudcts as $flash)
                            <div class="col-xl-2 col-md-4">
                                <div class="product-wrapper" data-aos="fade-up">
                                    <div class="product-img">
                                        <img src="{{ asset('uploads/products/' . $flash->images->first()->file_name) }}"
                                            alt="product-img">
                                    </div>
                                    <div
                                        class="position-absolute top-0 start-0 bg-danger text-white py-1 px-2 m-2 rounded">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="product-description">
                                            <a href="{{ route('website.products.show', $flash->slug) }}"
                                                class="product-details">{{ $flash->name }}
                                            </a>
                                            <div class="price">
                                                @if ($flash->has_variants == 1)
                                                    <span class="new-price">{{ __('dashboard.has_variants') }}</span>
                                                @else
                                                    <span class="price-cut">{{ $flash->price }} EGP</span>
                                                    <span class="new-price">{{ $flash->getPriceAfterDiscount() }}
                                                        EGP</span>
                                                @endif
                                            </div>
                                        </div>

    ...
    <section class="blog about-blog">
        <div class="container">
            <div class="blog-bradcrum">
                ...
                <span><a href="javascript:;">@lang('dashboard.products')</a></span>
            </div>
            <div class="blog-heading about-heading">
                <h1 class="heading">@lang('dashboard.products')</h1>
            </div>
        </div>
    </section>
    @if ($products->count() > 0)

        <section class="product @if ($type == 'flash_timer') flash-sale @endif product-sidebar footer-padding">
            <div class="container">
                <div class="row g-5">
                    {{-- <div class="col-lg-3">
                        <div class="sidebar" data-aos="fade-right">
                            <div class="sidebar-section">
                                <div class="sidebar-wrapper">
                                    <h5 class="wrapper-heading">Product
                                        Categories</h5>
                                    ...
                                    <div class="sidebar-item">
                                        <ul class="sidebar-list">
                                            <li>
                                                ...
                                                <label for="thread">Refined
                                                    Threads
                                                </label>
                                            </li>
                                            <li>
                                                <input type="checkbox" id="ethereal" name="ethereal">
                                                <label for="ethereal">Ethereal
                                                    Chic</label>
                                            </li>
                                            <li>
                            ...
                            <div class="sidebar-shop-section">
                                ...
                                <h5 class="wrapper-heading">Best wireless
                                    Shoes</h5>
                            ...
                            <div class="row g-5">
                                ...
                                <div class="col-lg-12">
                                    <div class="product-sorting-section">
                                        <div class="result">
                                            @if ($products->count() > 0)
                                                <p>Showing <span>{{ $products->firstItem() }}–{{ $products->lastItem() }} of
                                                        {{ $products->total() }}
                                                        results</span></p>
                                            @else
                                                <p>Showing <span>0
                                                ...
                                                <div class="product-description">
                                                    ...
                                                    <div class="price">
                                                        @if ($product->has_variants == 1)
                                                            <span
                                                                class="new-price">{{ __('dashboard.has_variants') }}</span>
                                                        @else

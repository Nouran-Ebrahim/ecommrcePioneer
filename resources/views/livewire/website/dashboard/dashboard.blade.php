 <div>
        @if($screen == 'dashboard')
             <div class="tab-pane fade  @if ($screen == 'dashboard') active show @endif">
             <div class="user-profile">
                 <div class="user-title">
                     <p class="paragraph">Hello, {{$auth_user->name }}</p>
                     ...
                     <div class="row g-5">
                         <div class="col-lg-4 col-sm-6">
                             <div class="product-wrapper">
                                 ...
                                 <div class="wrapper-content">
                                     ...
                                     <h3 class="heading">{{ $new_orders_count }}</h3>
                                 </div>
                             </div>
                         </div>
                         <div class="col-lg-4 col-sm-6">
                             <div class="product-wrapper">
                                 ...
                                 <div class="wrapper-content">
                                     ...
                                     <h3 class="heading">{{ $delivered_orders_count }}</h3>
                                 </div>
                             </div>
                         </div>
                         <div class="col-lg-4 col-sm-6">
                         ...
                         <div class="col-lg-12">
                             <div class="info-section">
                                     ...
                                     <div class="info-list">
                                         ...
                                         <div class="info-details">
                                             ...
                                             <p><a href="javascript:void(0)"
                                                     class="__cf_email__">{{ $auth_user->email }}</a>
                                             </p>
                                             <p> {{ $auth_user->phone == null ? 'Not Provided' : $auth_user->phone }}
                                             </p>
                                         </div>
                                     </div>
                                 </div>
                                 ...
                                 <div class="shop-info">
                                     <h5 class="heading">Address Information</h5>
                                     <div class="info-list">
                                         <div class="info-title">
                                             <p>Country:</p>
                                             <p>Governorate:</p>

    ...
    <form class="wizard-circle">
        ...
        <div class="setup-content {{ $currentStep != 1 ? 'displayNone' : '' }}" id="step-1">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="firstName2"> {{ __('dashboard.name_ar') }} :</label>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        {{-- wire:model is name of input and when add live to make real time validation and in class use updated hockes to validate the data --}}
                        <label for="firstName2"> {{ __('dashboard.name_en') }} :</label>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="date"> {{ __('dashboard.tags') }} :</label>
        ...
        <div class="setup-content {{ $currentStep != 2 ? 'displayNone' : '' }}" id="step-2">
            <div class="row">
                ...
                @if ($has_discount == 1 && $has_variants == 0)
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label for="start_discount">{{ __('dashboard.start_date') }}</label>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label for="end_discount">{{ __('dashboard.end_date') }}</label>
